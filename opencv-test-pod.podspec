Pod::Spec.new do |s|
    s.name = "opencv-test-pod"
    s.version = "4.11.0"
    s.summary = "OpenCV for iOS, compatible with react-native-executorch."
    s.homepage = "https://github.com/JakubGonera/opencv-test-pod.git"
    s.authors = { "Jakub Mroz" => "jakub.gonera@swmansion.com" }
    s.license = { :type => 'Apache License 2.0', :file => 'LICENSE' }
    s.source = { 
      :git => "https://github.com/JakubGonera/opencv-test-pod.git", 
      :tag => "#{s.version}"
    }
    s.platform = :ios
